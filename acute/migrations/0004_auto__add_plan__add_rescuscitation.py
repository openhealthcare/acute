...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'acute_plan', (
            ...
            ('plan', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'acute', ['Plan'])

        # Adding model 'Rescuscitation'
        db.create_table(u'acute_rescuscitation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('consistency_token', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('episode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'])),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'acute', ['Rescuscitation'])


    def backwards(self, orm):
        # Deleting model 'Plan'
        db.delete_table(u'acute_plan')

        # Deleting model 'Rescuscitation'
        db.delete_table(u'acute_rescuscitation')
