...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Clerking'
        db.create_table(u'acute_clerking', (
            ...
            ('clerked_by', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('consultant', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'acute', ['Clerking'])


    def backwards(self, orm):
        # Deleting model 'Clerking'
        db.delete_table(u'acute_clerking')
