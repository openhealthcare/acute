...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'acute_treatment', (
            ...
            ('route_fk', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Drugroute'], null=True, blank=True)),
            ('route_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True)),
            ...
            ('frequency_fk', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Drugfreq'], null=True, blank=True)),
            ('frequency_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'acute', ['Treatment'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'acute_treatment')
