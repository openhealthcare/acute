...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NursingNotes'
        db.create_table(u'acute_nursingnotes', (
        ...
        db.send_create_signal(u'acute', ['NursingNotes'])

        # Adding model 'DischargeDue'
        db.create_table(u'acute_dischargedue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('consistency_token', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('episode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'])),
            ('date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'acute', ['DischargeDue'])


    def backwards(self, orm):
        # Deleting model 'NursingNotes'
        db.delete_table(u'acute_nursingnotes')

        # Deleting model 'DischargeDue'
        db.delete_table(u'acute_dischargedue')
    ...
    models = {
        ...
        u'acute.clerking': {
            'Meta': {'object_name': 'Clerking'},
            'clerked_by': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'consistency_token': ('django.db.models.fields.CharField', [], {'max_length': '8'}),
            'consultant': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
        ...
        u'acute.dischargedue': {
            'Meta': {'object_name': 'DischargeDue'},
            'consistency_token': ('django.db.models.fields.CharField', [], {'max_length': '8'}),
        ...
        u'acute.nursingnotes': {
            'Meta': {'object_name': 'NursingNotes'},
            'consistency_token': ('django.db.models.fields.CharField', [], {'max_length': '8'}),
            'episode': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['opal.Episode']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'acute.plan': {
            ...
            'episode': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['opal.Episode']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'plan': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        u'acute.rescuscitation': {
            'Meta': {'object_name': 'Rescuscitation'},
            'consistency_token': ('django.db.models.fields.CharField', [], {'max_length': '8'}),
            'episode': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['opal.Episode']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
